            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>Merek Mobil</TableCell>
                  <TableCell>Jumlah Kuris</TableCell>
                  <TableCell>Status Mobil</TableCell>
              ...
              <TableBody>
                {data.slice(0, rowsPerPage).map( (dt,dataIndex) => (
                  ...
                  >
                    ...
                    <TableCell>{dt.merek_mobil}</TableCell>
                    <TableCell>{dt.jumlah_kursi}</TableCell>
                    <TableCell>{dt.status_mobil}</TableCell>
